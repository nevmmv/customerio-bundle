...
include_once $this->targetDirs[4].'/vendor/symfony/http-kernel/CacheWarmer/CacheWarmerAggregate.php';
...
}, 2), true, ($this->targetDirs[0].'/testsSymfonyLab_Tests_TestKernelTestDebugContainerDeprecations.log'));
