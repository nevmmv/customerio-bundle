...
include_once $this->targetDirs[4].'/vendor/symfony/cache-contracts/CacheInterface.php';
...
include_once $this->targetDirs[4].'/vendor/symfony/cache/Traits/AbstractAdapterTrait.php';
include_once $this->targetDirs[4].'/vendor/symfony/cache-contracts/CacheTrait.php';
...
$this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('sREZHglzwX', 0, ($this->targetDirs[0].'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
